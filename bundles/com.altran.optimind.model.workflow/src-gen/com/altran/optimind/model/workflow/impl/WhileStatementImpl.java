 ...
 * </p>
 * <ul>
 *   <li>{@link com.altran.optimind.model.workflow.impl.WhileStatementImpl#getAbstracttask <em>Abstracttask</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WhileStatementImpl extends AbstractStatementImpl implements WhileStatement {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.WHILE_STATEMENT;
	}
	...
	public NotificationChain basicSetAbstracttask(AbstractTask newAbstracttask, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					WorkflowPackage.WHILE_STATEMENT__ABSTRACTTASK, oldAbstracttask, newAbstracttask);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newAbstracttask != abstracttask) {
			...
			if (abstracttask != null)
				msgs = ((InternalEObject) abstracttask).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - WorkflowPackage.WHILE_STATEMENT__ABSTRACTTASK, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.WHILE_STATEMENT__ABSTRACTTASK,
					newAbstracttask, newAbstracttask));
	}

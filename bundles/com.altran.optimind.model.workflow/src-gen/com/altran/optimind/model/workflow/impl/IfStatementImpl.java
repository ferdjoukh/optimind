 ...
 * </p>
 * <ul>
 *   <li>{@link com.altran.optimind.model.workflow.impl.IfStatementImpl#getThen <em>Then</em>}</li>
 *   <li>{@link com.altran.optimind.model.workflow.impl.IfStatementImpl#getElse <em>Else</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfStatementImpl extends AbstractStatementImpl implements IfStatement {
	...
	public NotificationChain basicSetThen(AbstractTask newThen, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					WorkflowPackage.IF_STATEMENT__THEN, oldThen, newThen);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newThen != then) {
			...
			if (then != null)
				msgs = ((InternalEObject) then).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - WorkflowPackage.IF_STATEMENT__THEN, null, msgs);
			if (newThen != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.IF_STATEMENT__THEN, newThen,
					newThen));
	}
	...
	public NotificationChain basicSetElse(AbstractTask newElse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					WorkflowPackage.IF_STATEMENT__ELSE, oldElse, newElse);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newElse != else_) {
			...
			if (else_ != null)
				msgs = ((InternalEObject) else_).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - WorkflowPackage.IF_STATEMENT__ELSE, null, msgs);
			if (newElse != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.IF_STATEMENT__ELSE, newElse,
					newElse));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case WorkflowPackage.IF_STATEMENT__THEN:
			return basicSetThen(null, msgs);
		case WorkflowPackage.IF_STATEMENT__ELSE:

 ...
 * </p>
 * <ul>
 *   <li>{@link com.altran.optimind.model.workflow.impl.OutputImpl#getTypeAsString <em>Type As String</em>}</li>
 *   <li>{@link com.altran.optimind.model.workflow.impl.OutputImpl#getValueAsString <em>Value As String</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputImpl extends NamedElementImpl implements Output {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.OUTPUT;
	}
	...
	public void setTypeAsString(String newTypeAsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.OUTPUT__TYPE_AS_STRING,
	...
	public void setValueAsString(String newValueAsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.OUTPUT__VALUE_AS_STRING,
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			...
			case WorkflowPackage.TYPED_ELEMENT__TYPE_AS_STRING:
				return WorkflowPackage.OUTPUT__TYPE_AS_STRING;
			case WorkflowPackage.TYPED_ELEMENT__VALUE_AS_STRING:
				return WorkflowPackage.OUTPUT__VALUE_AS_STRING;
			default:
				return -1;
			}
		}

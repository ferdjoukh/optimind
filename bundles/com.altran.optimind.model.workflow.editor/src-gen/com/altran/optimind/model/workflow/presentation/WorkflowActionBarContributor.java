...
public class WorkflowActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction showPropertiesViewAction = new Action(
			WorkflowEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			WorkflowEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				...
				"com.altran.optimind.model.workflowMenuID");
		...
		createSiblingMenuManager = new MenuManager(
				WorkflowEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));

...
public class OptimindParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OptimindGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getForAccess().getAbstracttaskAssignment_9(), "rule__For__AbstracttaskAssignment_9");
			builder.put(grammarAccess.getWhileAccess().getConditionAssignment_3(), "rule__While__ConditionAssignment_3");
			builder.put(grammarAccess.getWhileAccess().getAbstracttaskAssignment_5(), "rule__While__AbstracttaskAssignment_5");
			builder.put(grammarAccess.getIfAccess().getConditionAssignment_3(), "rule__If__ConditionAssignment_3");
			builder.put(grammarAccess.getIfAccess().getThenAssignment_5(), "rule__If__ThenAssignment_5");
			builder.put(grammarAccess.getIfAccess().getElseAssignment_6_1(), "rule__If__ElseAssignment_6_1");
			...
			builder.put(grammarAccess.getBaseTaskAccess().getAbstractstatementAssignment_8(), "rule__BaseTask__AbstractstatementAssignment_8");

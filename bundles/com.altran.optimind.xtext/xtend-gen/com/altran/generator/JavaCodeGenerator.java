...
public class JavaCodeGenerator {
  ...
  public JavaCodeGenerator(final Workflow workflow, final String filePath) {
  ...
  public String generateClassContent() {
    ...
    String _name_1 = this.workflow.getName();
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public BaseTask run_workflow()");
    _builder.newLine();
    _builder.append("{");
    _builder.newLine();
    _builder.append("\t");
    ...
    String _name_2 = rootBasetask.getName();
          ...
          for(final AbstractTask childTask : childrenTasks) {
            ...
            }
            {
              if ((childTask instanceof LibraryTask)) {
                ...
                _builder.append(".addTaskToList(");
                String _name_8 = ((LibraryTask)childTask).getName();
            ...
            }
            {
              if ((childTask instanceof CustomTask)) {
                ...
                String _name_9 = ((CustomTask)childTask).getName();
                _builder.append(_name_9);
                _builder.append(" = new CustomTask(\"");
                String _name_10 = ((CustomTask)childTask).getName();
                _builder.append(_name_10);
                _builder.append("\",");
                String _name_11 = task.getName();
